...
class SignUpBasicInfo extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      basicInfo: this.props.navigation.getParam("basicInfo", {}),
    });
  }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.dropdownContainer}>
            ...
            <MultiSelectSearchableDropdown
              ...
              modalHeaderText={
                "Please select all the classes you would like to tutor for"
              }
...
export default connect(null, mapDispatchToProps)(SignUpBasicInfo);
