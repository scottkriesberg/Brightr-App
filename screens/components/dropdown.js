...
export class Dropdown extends Component {
    ...
    togglePicker() {
        this.setState((prevState) => ({
            pickerDisplayed: !prevState.pickerDisplayed,
        }));
    }
    ...
    render() {
        ...
        return (
            <View style={[styles.container, containerStyle]}>
                <Text style={[styles.dropDownHeaderText, titleStyle]}>
                    {dropdownTitle}
                </Text>
                <TouchableOpacity
...
export class MultiSelectSearchableDropdown extends Component {
    ...
    render() {
        const { dropdownTitle, doneFunc } = this.props;

        return (
            <View style={styles.multiContainer}>
                <View style={styles.multiTochableContainer}>
                    <TouchableOpacity
                        style={styles.multiSelectedTouchable}
                        onPress={() => this.togglePicker()}
                    >
                        <Text style={styles.multiDropDownHeaderText}>
                            {dropdownTitle}
                        </Text>
                    </TouchableOpacity>
                </View>
                    ...
                    <View style={styles.searchModalView}>
                        ...
                        <View style={styles.multiCancelModalButtonContainer}>
                            <TouchableHighlight
                                ...
                                style={styles.cancelModalButton}
                            >
                                <Text style={styles.multiDoneModalButtonText}>
                                    Done
                                </Text>
                            </TouchableHighlight>
                        </View>
