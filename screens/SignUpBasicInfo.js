...
class SignUpBasicInfo extends React.Component {
    ...
    informationValidation() {
        ...
        if (valid) {
            this.props.navigation.navigate('SignUpBioClasses', {
            ...
            >
                ...
                >
                    <View style={styles.textInputContainer}>
                        <Text style={styles.textInputHeadingText}>
                            Full Name
                        </Text>
                        <TextInput
                    ...
                    <View style={styles.dropdownContainer}>
                        ...
                        {this.state.tutor ? (
                            <Text style={styles.textInputGPAHeadingText}>
                                GPA
                            </Text>
                        ) : null}
                    ...
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity
                            style={styles.button}
                            onPress={() => this.informationValidation()}
                        >
                            <Text
